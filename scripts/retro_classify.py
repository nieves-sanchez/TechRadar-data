...
from scripts.load import _resolve_skill_id_map, upsert_skills_and_links
...
# _resolve_skill_id_map() y upsert_skills_and_links() se movieron a load.py en
# FASE B (Paso 1, §57.6.11 de notes/PROJECT_MASTER_CONTEXT.md): fuente única de
# verdad, reutilizable también por scripts/enrich.py sin duplicar la lógica de
# canonicalización. Importadas arriba desde scripts.load (ver cabecera del
# módulo). Pipeline C, y los tests que las importan o parchean vía
# scripts.retro_classify.*, siguen funcionando sin cambios: el import directo
# las deja como atributos normales de este módulo.
